...
// by KaijinQ https://www.openprocessing.org/user/44852
// https://www.openprocessing.org/sketch/446828
// fork by Rupert Russell
// Artwork at Redbubble see: https://www.redbubble.com/people/rupertrussell/works/33972286-green-yellow-kirlian-mandelbrot?asc=u
// Code on Github at: 

int N = 100 ; // Density of lines // speed of drawing larget = faster more dense
float L = 0.01 ; // length of segments 
float AA = 0.05 ; // wavyness of lines  0.1 smaller less wavey
int IImax = 1000 ; // Number of itterations
float Zmax = 100 ;
float Xmin = -2 ; 
float Ymin= -1.5 ; 
float Xmax = +1 ; 
...
void saveimage() {
  ...
  save("mandelbrot_9_" + counter + ".png");
